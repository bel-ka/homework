...
public class DemoAtm {
    public static void main(String[] args) {
        ...
        System.out.println("department1 before save: " + department1.getBalance());
        department1.saveState();
        ...
        System.out.println("department1 before reset: " + department1.getBalance());
        department1.resetToSavedState();
        System.out.println("department1 after reset: " + department1.getBalance());
    }
}
